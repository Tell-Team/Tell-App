            ...
            \subsubsection{Descrizioni}
                ...
                \begin{table}[H]
                    \begin{tabular}{|p{\linewidth}|}
                        ...
                        \textbf{Breve descrizione:} \\
                        \cellcolor{gray!20}
                        \textbf{Segmento 1:} L'utente modifica le informazioni relative a uno spettacolo. \\
                        \hline
                        \textbf{Attori primari:} \\
                        \begin{minipage}{\linewidth}
                            Biglietteria \\
                        ...
                        \begin{enumerate}
                            ...
                            \item L'utente modifica i dati desiderati dello spettacolo.
                            \item[] \textbf{punto di estensione:} creaEvento
                            \item[] \textbf{punto di estensione:} modificaEvento
                            \item L'utente conferma la modifica dello spettacolo.
                            \item Il Sistema verifica i dati e li salva in memoria.
                        \end{enumerate} \\
                        \hline
                        \cellcolor{gray!20}
                ...
                \begin{table}[H]
                    \begin{tabular}{|p{\linewidth}|}
                        ...
                        \textbf{Breve descrizione:} \\
                        \cellcolor{gray!20}
                        \textbf{Segmento 1:} L'utente elimina uno spettacolo dal Sistema. \\
                        \hline
                        \textbf{Attori primari:} \\
                        \begin{minipage}{\linewidth}
                            Biglietteria \\
                        ...
                        \begin{minipage}{\linewidth}
                            \begin{enumerate}
                                \item L'utente effettua l'elimina di uno spettacolo (e i suoi eventi).
                            \end{enumerate}
                        \end{minipage} \\
                        \hline
                    \end{tabular}
