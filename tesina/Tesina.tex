...
\usepackage{varwidth}
\usepackage{enumitem}
\setlist[enumerate]{label*=\arabic*., topsep=0pt} % Imposta gli indici di tutti i livelli di enumerazione come numeri arabi (invece del default che passa alle lettere)
