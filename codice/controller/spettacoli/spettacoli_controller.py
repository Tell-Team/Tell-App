...
class SpettacoliController:
    ...
    def nuova_regia(self, id_opera: int):
        ...
        self.navigation_get_page.emit("nuova_regia", cur_page)
        ...
        self.navigation_go_to.emit("nuova_regia", True)
    ...
    def modifica_regia(self, id_: int, id_opera: int):
        ...
        cur_page: Optional[QWidget] = QWidget()
        self.navigation_get_page.emit("modifica_regia", cur_page)
        ...
        self.navigation_go_to.emit("modifica_regia", True)
