...
from view.utils.custom_button import DefaultButton, EliminaButton

from view.style.ui_style import WidgetRole, WidgetColor


class PrenotazioneDisplay(ItemDisplay):
    """View delle singole prenotazioni della Lista Prenotazioni per la sezione Prenotazioni.
    ...
    def __init__(self, p: Prenotazione):
        super().__init__()
    ...
    def __connect_signals(self, p: Prenotazione) -> None:
        self.__id = p.get_id()
