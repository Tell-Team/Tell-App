    ...
    \section{Casi d'uso}
        ...
        \subsection{Cliente}
            ...
            \subsubsection{Descrizioni}
                    ...
                    \begin{tabular}{|p{\linewidth}|}
                        ...
                        \begin{enumerate}
                            ...
                            \begin{enumerate}
                                ...
                                \item \textbf{For} ogni spettacolo nell'elenco visualizzato
                                \begin{enumerate}
                                    \item[] \textbf{punto di estensione:} visualizzaSpettacolo
                                \end{enumerate}
                            \end{enumerate}
                            \item \textbf{Else}
                            \begin{enumerate}
                ...
                % UC EXT: Visualizza Spettacolo
                \begin{table}[H]
                    \begin{tabular}{|p{\linewidth}|}
                        \hline
                        \cellcolor{gray!100}
                        \color{white}
                        \centerline{\textbf{Caso d'uso di estensione:} Visualizza Spettacolo} \\
                        \hline
                        \textbf{ID:} 7 \\
                        \hline
                        \cellcolor{gray!20}
                        \textbf{Breve descrizione:} \\
                        \cellcolor{gray!20}
                        \textbf{Segmento 1:} L'utente visualizza i dettagli di uno spettacolo selezionato dalla lista. \\
                        \hline
                        \textbf{Attori primari:} \\
                        \begin{minipage}{\linewidth}
                            Cliente \\
                        ...
                        \textbf{Sequenza degli eventi principale del segmento 1:}
                        \begin{enumerate}
                            \item Il Sistema mostra i dettagli dello spettacolo: titolo, descrizione, durata, ecc.
                            \item \textbf{include}(Lista Eventi)
                            \item \textbf{If} l'utente è stato autenticato come Amministratore
                            \begin{enumerate}
            ...
            \subsubsection{Descrizioni}
                ...
                \begin{table}[H]
                    \begin{tabular}{|p{\linewidth}|}
                        ...
                        \textbf{Breve descrizione:} \\
                        \cellcolor{gray!20}
                        \textbf{Segmento 1:} Questo caso d'uso consente di filtrare l'elenco delle prenotazioni attraverso una ricerca. \\
                        \hline
                        \textbf{Attori primari:} \\
                        \begin{minipage}{\linewidth}
                            Biglietteria \\
