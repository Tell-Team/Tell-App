...
class LoginPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.__btn_cliente.setProperty(QssStyle.BLUE_BUTTON, True)
        self.__btn_cliente.setProperty(QssStyle.MAIN_BUTTON, True)

        self.__btn_biglietteria = QPushButton("Biglietteria")
        self.__btn_biglietteria.setProperty(QssStyle.BLUE_BUTTON, True)
        self.__btn_biglietteria.setProperty(QssStyle.MAIN_BUTTON, True)

        self.__btn_admin = QPushButton("Amministratore")
        self.__btn_admin.setProperty(QssStyle.BLUE_BUTTON, True)
        self.__btn_admin.setProperty(QssStyle.MAIN_BUTTON, True)
