    ...
    \section{Casi d'uso}
        ...
        \subsection{Cliente}
            ...
            \subsubsection{Descrizioni}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} ListaSpettacoli
                    \end{center} \\
                            \textbf{ID:} 5\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d'uso consente di visualizzare l'elenco completo degli spettacoli disponibili presso il teatro. \\
                    \hline
                    \textbf{Attori primari:} 
                    
                    Spettatore, Amministratore \\
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Precondizioni:} 
                    ...
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l'attore primario richiede di visualizzare la lista completa degli spettacoli;
                        
                        \item Il sistema mostra a schermo l'elenco aggiornato degli spettacoli programmati, con informazioni essenziali (titolo, data, ora, sala);
                        
                        \item \textit{if }L'attore primario desidera cercare uno spettacolo specifico:
                        \begin{enumerate}
                            \item \textit{include}(RicercaSpettacolo);
                        \end{enumerate}
                        
                        \item \textit{if }L'attore primario desidera visualizzare i dettagli di uno spettacolo selezionato:
                        \begin{enumerate}
                            \item \textit{include}(VisualizzaSpettacolo);
                        \end{enumerate}
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
            ...
            \end{table}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} RicercaSpettacolo
                    \end{center} \\
                \textbf{ID:} 6\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d'uso consente di effettuare una ricerca tra gli spettacoli disponibili, applicando eventuali filtri (es. titolo, data, genere). \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    L’attore ha effettuato l’accesso al sistema e ha accesso alla lista spettacoli. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’attore accede alla funzione di ricerca spettacolo;
                        
                        \item Il sistema mostra un’interfaccia con i campi per filtrare (titolo, data, genere, ecc.);
                        
                        \item L’attore inserisce uno o più criteri di ricerca;
                        
                        \item Il sistema elabora la richiesta e mostra i risultati corrispondenti;
                        
                        \item \textit{if} L’attore seleziona uno spettacolo dai risultati:
                        \begin{enumerate}
                            \item \textit{include}(VisualizzaSpettacolo);
                        \end{enumerate}
                    \end{enumerate} \\ 
                    ...
                    I risultati della ricerca vengono mostrati all’attore. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item Nessun risultato trovato: il sistema notifica all’attore che nessuno spettacolo corrisponde ai criteri.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} VisualizzaSpettacolo
                    \end{center} \\
            \textbf{ID:} 7\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d'uso consente all'utente di visualizzare i dettagli di uno spettacolo selezionato dalla lista. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    L'attore ha selezionato uno spettacolo dalla lista. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’attore seleziona uno spettacolo dalla lista;
                        
                        \item Il sistema mostra i dettagli dello spettacolo: titolo, descrizione, durata, regista, cast, eventi collegati ecc.;
                        
                        \item \textit{if}  l'attore ha i permessi di amministratore:
                        \begin{enumerate}
                            \item \textit{extend}(ModificaSpettacolo);
                            \item \textit{extend}(EliminaSpettacolo);
                        \end{enumerate}
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
            ...
            \textbf{ID:} 8\\
                    ...
                    Questo caso d'uso consente di visualizzare l'elenco di tutti gli eventi programmati per gli spettacoli. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’attore accede alla sezione “Eventi”;
                        
                        \item Il sistema mostra una lista di eventi con informazioni rilevanti (spettacolo, data, ora, sala);
                        
                        \item L’attore può filtrare o ordinare gli eventi secondo criteri specifici;
                        
                        \item \textit{include}(ModificaEvento), \textit{include}(EliminaEvento) se l’attore è un amministratore.
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Postcondizioni:} 
                    
                    L’attore ha visualizzato l’elenco degli eventi. \\
                    \hline 
        ...
        \subsection{Biglietteria}
            ...
            \subsubsection{Descrizioni}
                ...
                \begin{table}[H]
                    \begin{tabular}{|p{\linewidth}|}
                        ...
                        \textbf{Breve descrizione:} \\
                        \cellcolor{gray!20}
                        L'utente crea l'istanza di uno spettacolo svolto nel teatro. \\
                        \hline
                        \textbf{Attori primari:} \\
                        \begin{minipage}{\linewidth}
                            Biglietteria \\
                        ...
                        \begin{minipage}{\linewidth}
                            \begin{enumerate}
                                ...
                                \item L'utente si trova nella categoria ”Spettacolo”. %/""
                            \end{enumerate}
                        \end{minipage} \\
                        \hline
                        \textbf{Sequenza degli eventi principale:}
                        \begin{enumerate}
                            \item Il caso d'uso inizia quando l'utente preme il pulsante di creazione.
                            \item Il Sistema mostra una interfaccia per inserire dati e impostazioni relativi allo spettacolo.
                            \item L'utente inserisce i dati anagrafici dello spettacolo.
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} ModificaSpettacolo
                    \end{center} \\
            \textbf{ID:} 18\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d'uso consente all'amministratore di modificare le informazioni relative a uno spettacolo selezionato. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    L’amministratore ha visualizzato i dettagli di uno spettacolo. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’amministratore seleziona l’opzione di modifica per uno spettacolo;
                        
                        \item Il sistema presenta un modulo precompilato con i dati dello spettacolo;
                        
                        \item L’amministratore modifica i dati desiderati (titolo, descrizione, durata, ecc.);
                        
                        \item \textit{include}(ModificaEvento) per modificare anche eventuali eventi collegati;
                        
                        \item Il sistema salva le modifiche e conferma l’aggiornamento.
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Postcondizioni:} 
                    
                    Le informazioni dello spettacolo risultano aggiornate nel sistema. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item I dati inseriti non sono validi: il sistema mostra un messaggio di errore e richiede la correzione.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} EliminaSpettacolo
                    \end{center} \\
            \textbf{ID:} 19\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d'uso consente all'amministratore di eliminare uno spettacolo dal sistema. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’amministratore seleziona l’opzione per eliminare uno spettacolo;
                        
                        \item Il sistema richiede conferma dell’operazione;
                        
                        \item L’amministratore conferma l’eliminazione;
                        
                        \item Il sistema elimina lo spettacolo e tutti gli eventi associati;
                        
                        \item \textit{include}(EliminaEvento) per rimuovere anche gli eventi collegati.
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Postcondizioni:} 
                    
                    Lo spettacolo e i suoi eventi non sono più presenti nel sistema. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item L’amministratore annulla l’operazione: il sistema non esegue modifiche.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
            ...
            \textbf{ID:} 20\\
                    ...
                    Questo caso d'uso consente all’amministratore di creare un nuovo evento associato a uno spettacolo esistente. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    Lo spettacolo a cui associare l’evento è già presente nel sistema. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’amministratore seleziona l’opzione per aggiungere un nuovo evento;
                        
                        \item Il sistema mostra un modulo per l’inserimento dei dati dell’evento (data, ora, sala, disponibilità posti);
                        
                        \item L’amministratore compila i campi richiesti e conferma la creazione;
                    ...
                    Il nuovo evento risulta associato allo spettacolo selezionato. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item Dati non validi o sala non disponibile: il sistema mostra un errore e impedisce il salvataggio.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} ModificaEvento
                    \end{center} \\
            \textbf{ID:} 21\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d’uso permette all’amministratore di aggiornare i dettagli di un evento programmato. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    L’evento da modificare è presente nel sistema. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’amministratore seleziona un evento da modificare;
                        
                        \item Il sistema mostra i dati correnti dell’evento in un modulo;
                        
                        \item L’amministratore aggiorna le informazioni desiderate (data, ora, sala, disponibilità posti);
                        
                        \item Il sistema salva le modifiche e aggiorna l’evento.
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Postcondizioni:} 
                    
                    L’evento risulta aggiornato nel sistema. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item Dati non validi o conflitto con altri eventi: il sistema mostra un messaggio di errore.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
                ...
                \begin{tabular}{|p{\linewidth}|}
                    ...
                    \begin{center}
                        \color{white}
                        \textbf{Caso d'uso:} EliminaEvento
                    \end{center} \\
            \textbf{ID:} 22\\
                    \hline
                    \cellcolor{gray!20}
                    ...
                    Questo caso d’uso consente all’amministratore di eliminare un evento associato a uno spettacolo. \\
                    \hline
                    \textbf{Attori primari:} 
                    ...
                    L’evento da eliminare è già stato creato e visibile nel sistema. \\
                    \hline
                    \begin{enumerate}
                        \item Il caso d’uso inizia quando l’amministratore seleziona un evento e sceglie di eliminarlo;
                        
                        \item Il sistema mostra un messaggio di conferma;
                        
                        \item L’amministratore conferma l’eliminazione;
                        
                        \item Il sistema rimuove l’evento dal database.
                    \end{enumerate} \\ 
                    \hline
                    \cellcolor{gray!20}
                    \textbf{Postcondizioni:} 
                    
                    L’evento non è più disponibile nel sistema. \\
                    \hline 
                    
                    \textbf{Sequenza degli eventi alternativa:} \\ 
                    \begin{itemize}
                        \item L’amministratore annulla l’operazione: nessuna modifica viene effettuata.
                    \end{itemize} \\
                    \hline
                \end{tabular}
            \end{table}
